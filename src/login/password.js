    ...
    return (
      ...
      <div className="wrap">
        ...
        <p>New Password <span>*</span></p>
            <input className={passwordStyle} classnames="password" name="password" type={ this.state.passwordType } placeholder="Enter new password" onBlur={this.handlePassInput} onChange={this.saveInput}/>
            ...
            <button className="showPass" name="showPass2" onClick={this.handleTooglePass}>{this.state.textValue}</button>
        </div>
        <div>        
        <p>Confirm Password <span>*</span></p>
            <input className={passwordStyle} classnames="password" name="password" type={ this.state.passwordType } placeholder="Confirm password" onBlur={this.handlePassInput} onChange={this.saveInput}/>
