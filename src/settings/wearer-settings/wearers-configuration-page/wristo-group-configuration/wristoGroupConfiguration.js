...
const wristoDataTable = this.state.wearerDevice.map((wearerDeviceObject) => {
        ...
        if(this.props.wearerDeviceData.length !== 0 ) {  
          ...
          let inputStyle = classNames({
            ...
            <td>
              { toogleButton  ? <div className="wristoDevicesButton"> <button className="edit-group" onClick={()=> this.hadnleClickEditButton(wearerDeviceObject.id)}> 
...
//<AddNewWristo addNewWristo = {this.handleAddNewWristo} wearerID={this.state.wearerID}/>
          ...
          <div className="wristoDeviceWrap">
